<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="fed_view.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="container_24">
    ...
    <div class="grid_16">
      <div class="top-1">
        <h4 class="h4-border"><strong>Feedback</strong>Detail:</h4>
          <p class="h4-border">&nbsp;</p>
